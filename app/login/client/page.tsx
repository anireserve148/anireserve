    ...
    return (
        <main className="flex items-center justify-center min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 p-4">
            <div className="w-full max-w-md space-y-4">
                <Link href="/" className="inline-flex items-center gap-2 text-gray-600 hover:text-emerald-600 transition-colors">
                ...
                <Card className="w-full shadow-2xl border-0 bg-white overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-emerald-500 to-teal-500 p-6 text-center">
                        ...
                        <p className="text-white/80 text-sm mt-1">Connectez-vous pour gérer vos réservations</p>
                    </div>
                    ...
                    <CardContent className="space-y-4 p-6">
                        ...
                        <Button
                            type="button"
                            variant="outline"
                            className="w-full font-semibold h-11 border-2 hover:bg-gray-50 bg-black text-white hover:bg-gray-900 hover:text-white"
                    ...
                    <CardFooter className="flex flex-col gap-3 pb-6 px-6 bg-gray-50">
                        ...
                        <div className="w-full border-t pt-3">
                            <p className="text-center text-sm text-gray-500">
                                ...
                                <Link href="/login/pro" className="text-[#1E3A5F] font-semibold hover:underline">
                                    Connexion Pro →
                                </Link>
                            </p>
                        </div>
